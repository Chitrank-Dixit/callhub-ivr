...
urlpatterns = [
    ...
    url(r"^request/ivr/edit/(?P<ivr_id>[0-99999])/(?P<user_id>[0-99999])/", "ivr.views.ivr_edit", name="ivr_edit"),
    # url(r"^response/ivr/", "ivr.views.ivr_view", name="ivr_view"),
    url(r"^response/ivr/(?P<ivr_id>[0-99999])/(?P<user_id>[0-99999])/", "ivr.views.ivr_endpoint", name="ivr_endpoint"),
    url(r"^response/ivr/list/" , "ivr.views.ivrs", name="ivrs"),
    url(r"^response/ivr/delete/(?P<ivr_id>[0-99999])/(?P<user_id>[0-99999])/", "ivr.views.ivr_delete", name="ivr_delete"),
